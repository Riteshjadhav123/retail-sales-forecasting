...
Executes the comprehensive pipeline strictly on the active dataset session with zero data leakage.
"""
...
from app.data.quality import DataQualityAuditor
from app.data.cleaner import DataCleaner
from app.features.feature_builder import FeatureBuilder
from app.forecasting.models.ml_models import MLForecaster
from app.forecasting.evaluator import evaluate_all_metrics
...
class DataPipelineExecutor:
    """Orchestrates end-to-end data processing, feature engineering, forecasting, and inventory evaluation."""
    ...
    def execute_full_pipeline(self) -> Dict[str, Any]:
        ...
        # Step 8 & 9: Inventory Optimization
