"""
src/intelligence/ask_assistant.py
Ask RetailMind Natural Language Retail Assistant
Answers operational questions strictly grounded in active session data.
Zero hallucinated metrics. Explicitly states data sources or data absence.
"""
