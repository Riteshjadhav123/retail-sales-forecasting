"""
Data Loader Module for Vaidsys Retail Sales Forecasting.
Handles downloading raw sales datasets and loading parquet / CSV files.
"""
...
def load_raw_dataset(path: Optional[str] = None) -> pd.DataFrame:
    ...
    if missing_cols:
        logger.warning(f"Raw dataset is missing expected columns: {missing_cols}")
